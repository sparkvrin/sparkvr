...
function AnatomySVG() { return <img loading="lazy" decoding="async" src="/human_anatomys.webp" alt="Anatomy" style={{ ...imgStyle, filter: "drop-shadow(0 4px 14px rgba(220,38,38,0.24))" }} />; }
