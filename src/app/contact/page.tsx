  ...
  return (
    <div>
      ...
      <section style={{
        ...
        <motion.div animate={{ y:[0,-15,0], opacity:[0.15,0.3,0.15] }} transition={{ duration:10,repeat:Infinity,ease:"easeInOut" }}
          style={{ position:"absolute",top:"30%",right:"15%",width:120,height:120,borderRadius:"50%",background:"rgba(31,179,255,0.08)",filter:"blur(50px)",pointerEvents:"none" }} />
