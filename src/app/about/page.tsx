  ...
  return (
    <div>
      ...
      <section style={{
        ...
        {/* Floating glows */}
        <motion.div animate={{ y:[0,-20,0], opacity:[0.2,0.4,0.2] }} transition={{ duration:10,repeat:Infinity,ease:"easeInOut" }}
          style={{ position:"absolute",top:"25%",left:"8%",width:120,height:120,borderRadius:"50%",background:"rgba(31,179,255,0.08)",filter:"blur(50px)",pointerEvents:"none" }} />
        <motion.div animate={{ y:[0,15,0], opacity:[0.15,0.3,0.15] }} transition={{ duration:12,repeat:Infinity,ease:"easeInOut",delay:3 }}
          style={{ position:"absolute",bottom:"15%",right:"12%",width:100,height:100,borderRadius:"50%",background:"rgba(204,47,255,0.06)",filter:"blur(40px)",pointerEvents:"none" }} />
        ...
        <div style={{ maxWidth:820,margin:"0 auto",textAlign:"center",position:"relative",zIndex:1 }}>
          ...
          <motion.h1 initial={{ opacity:0,y:32 }} animate={{ opacity:1,y:0 }} transition={{ delay:0.1 }}
            style={{ fontSize:"clamp(36px,5vw,64px)",fontWeight:700,color:"#ffffff",letterSpacing:"-0.02em",lineHeight:1.15 }}>
          ...
          <motion.div initial={{ opacity:0,x:40 }} whileInView={{ opacity:1,x:0 }} viewport={{ once:true }}
            ...
            {[
              ...
              <motion.div key={i}
                ...
                whileHover={{ y:-6, boxShadow:"0 12px 30px rgba(0,82,204,0.12)" }}
                style={{
      ...
      <section style={{ background:"rgba(255,255,255,0.3)", backdropFilter:"blur(20px)", padding:"96px 24px" }}>
        <div style={{ maxWidth:1120,margin:"0 auto" }}>
          <div style={{ textAlign:"center",marginBottom:64 }}>
            <p className="section-label" style={{ marginBottom:16 }}>What drives us</p>
