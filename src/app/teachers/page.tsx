...
export default function TeachersPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8f9fc" }}>
      ...
      <section style={{ padding: isMobile ? "90px 0 20px" : "100px 0 20px", background: "#ffffff", position: "relative", overflow: "hidden" }}>
        {!isMobile && (
          <motion.div
          ...
          >
            <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
              <motion.img loading="lazy" decoding="async"
                ...
                src="/teacher_1.webp" alt="VR Learning"
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px", position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", alignItems: "center", minHeight: isMobile ? "auto" : 280, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, maxWidth: isMobile ? "100%" : "45%", marginBottom: isMobile ? 32 : 0 }}>
              ...
              <motion.div {...fadeLeft(0.5)} whileHover={{ x: 5 }} style={{ background: "#f8fafc", borderRadius: 16, padding: "20px 24px", border: "1px solid #e2e8f0", display: "flex", gap: 16, alignItems: "center" }}>
                ...
                <div>
                  <h3 style={{ fontSize: isMobile ? 15 : 18, fontWeight: 800, color: "#0f172a", marginBottom: 4 }}>SparkVR empowers teachers. <span style={{ color: "#4f46e5" }}>It does not replace them.</span></h3>
          ...
          <motion.div {...fadeUp(0.6)} whileHover={{ y: -5 }} style={{ background: "#f8f9fc", borderRadius: 20, padding: isMobile ? "20px" : "24px 40px", display: "flex", alignItems: isMobile ? "flex-start" : "center", justifyContent: isMobile ? "flex-start" : "space-between", gap: isMobile ? 20 : 40, marginTop: 40, border: "1px solid #e2e8f0", flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
              <div style={{ width: 56, height: 56, borderRadius: 28, background: "#e0e7ff", display: "flex", alignItems: "center", justifyContent: "center", color: "#4f46e5", flexShrink: 0 }}>
                <Users size={28} strokeWidth={1.5} />
              </div>
              <div>
                <h4 style={{ fontSize: isMobile ? 15 : 18, fontWeight: 800, color: "#001a4d", margin: "0 0 4px 0" }}>Real teachers. Real classrooms. Real impact.</h4>
                <p style={{ fontSize: isMobile ? 13 : 16, color: "#6366f1", margin: 0, fontWeight: 600 }}>SparkVR is built for educators, by people who understand education.</p>
              </div>
            </div>
      ...
      <section style={{ padding: "40px 0", background: "#f8f9fc", position: "relative", overflow: "hidden" }}>
          ...
          >
            <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
              <motion.img loading="lazy" decoding="async"
                ...
                src="/teacher_2.webp" alt="VR Learning"
                style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}
              />
            </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px", position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", alignItems: isMobile ? "flex-start" : "center", minHeight: isMobile ? "auto" : 280, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, maxWidth: isMobile ? "100%" : "45%", marginBottom: isMobile ? 32 : 0 }}>
              <motion.div {...fadeLeft(0.1)} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                <Users size={20} color="#0052cc" />
                <span style={{ fontSize: 14, fontWeight: 800, color: "#0052cc", letterSpacing: "0.1em", textTransform: "uppercase" }}>TEACHERS STAY IN CONTROL</span>
              </motion.div>
              <motion.h2 {...fadeLeft(0.2)} style={{ fontSize: "clamp(32px, 4vw, 40px)", fontWeight: 900, color: "#001a4d", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 16 }}>
          ...
          <motion.div {...fadeUp(0.6)} style={{ display: "flex", gap: 24, marginTop: 40, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, background: "linear-gradient(135deg, #818cf8 0%, #a855f7 100%)", borderRadius: 16, padding: isMobile ? "24px 20px" : "32px 40px", display: "flex", alignItems: "center", gap: 24, boxShadow: "0 15px 30px rgba(139,92,246,0.2)" }}>
              <div style={{ width: 64, height: 64, borderRadius: 32, background: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#ffffff", flexShrink: 0 }}>
                <Users size={32} strokeWidth={1.5} />
              </div>
              <div>
                <h4 style={{ fontSize: isMobile ? 17 : 20, fontWeight: 800, color: "#ffffff", margin: "0 0 8px 0" }}>You are the educator. SparkVR is your ally.</h4>
                <p style={{ fontSize: isMobile ? 14 : 16, color: "rgba(255,255,255,0.9)", margin: 0, fontWeight: 500 }}>Technology that empowers your expertise.</p>
              </div>
            </div>
            <div style={{ flex: 1, background: "#ffffff", borderRadius: 16, padding: isMobile ? "24px 20px" : "32px 40px", display: "flex", alignItems: "center", gap: 24, boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #e2e8f0", flexWrap: "wrap" }}>
              <div style={{ color: "#4f46e5", flexShrink: 0 }}><MessageSquare size={48} strokeWidth={1.5} /></div>
              <div style={{ flex: 1, minWidth: 160 }}>
                <h4 style={{ fontSize: isMobile ? 15 : 18, fontWeight: 800, color: "#0f172a", margin: 0 }}>Great learning happens when<br /><span style={{ color: "#4f46e5" }}>great teaching leads the way.</span></h4>
              </div>
              {!isMobile && (
      ...
      <section style={{ padding: isMobile ? "40px 0" : "60px 0", background: "#ffffff", position: "relative", overflow: "hidden" }}>
        {!isMobile && (
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
              <motion.img loading="lazy" decoding="async" whileHover={{ scale: 1.05 }}
                src="/teacher_3.webp" alt="VR Learning Flow"
                style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}
              />
            </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px", position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", alignItems: "flex-start", minHeight: isMobile ? "auto" : 450, gap: 40, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1.2, maxWidth: isMobile ? "100%" : 500 }}>
              <motion.div {...fadeLeft(0.1)} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                <BookOpen size={20} color="#0052cc" />
                <span style={{ fontSize: 13, fontWeight: 800, color: "#4f46e5", letterSpacing: "0.1em", textTransform: "uppercase" }}>GUIDED CLASSROOM FLOW</span>
              </motion.div>
            ...
            {!isMobile && <div style={{ flex: 1.8, position: "relative" }} />}
          </div>

          {!isMobile && (
            <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: -2, position: "relative", zIndex: 10, perspective: 1000 }}>
              <motion.div
                initial={{ opacity: 0, y: 20, rotateX: 10 }}
                whileInView={{ opacity: 1, y: 0, rotateX: 0 }}
                whileHover={{ rotateX: 5, rotateY: -5, scale: 1.05, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
                transition={{ duration: 0.8, ease: EASE }}
                style={{ background: "rgba(255,255,255,0.98)", backdropFilter: "blur(10px)", padding: "16px 24px", borderRadius: "16px 16px 0 0", maxWidth: 320, border: "1px solid #e2e8f0", borderBottom: "none", cursor: "pointer", transformStyle: "preserve-3d" as const }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  <motion.div animate={{ rotateZ: [0, 5, -5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" as const }} style={{ width: 44, height: 44, borderRadius: 12, background: "linear-gradient(135deg, #f0f5ff 0%, #e0e7ff 100%)", display: "flex", alignItems: "center", justifyContent: "center", color: "#4f46e5", flexShrink: 0, boxShadow: "0 5px 15px rgba(79,70,229,0.1)" }}>
          ...
          <motion.div {...fadeUp(0.6)} style={{ background: "#ffffff", borderRadius: 20, padding: isMobile ? "16px" : "16px 24px", marginTop: 12, border: "1px solid #e2e8f0", boxShadow: "0 10px 30px rgba(0,0,0,0.02)" }}>
            ...
            {isMobile ? (
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                {[
                  ...
                  <motion.div key={idx} whileHover={{ y: -3 }} style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                    ...
                    <h4 style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", marginBottom: 2 }}>{step.title}</h4>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", position: "relative", width: "100%" }}>
                ...
                {[
                  ...
                  <motion.div key={idx} whileHover={{ y: -3 }} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", position: "relative", zIndex: 1 }}>
                    ...
                    <p style={{ fontSize: 10, color: "#64748b", margin: 0, lineHeight: 1.2 }}>{step.desc}</p>
                    {idx < 4 && <div style={{ position: "absolute", top: 24, right: -10, color: "#cbd5e1", opacity: 0.4 }}><Globe size={14} /></div>}
                  </motion.div>
                ))}
              </div>
            )}
          ...
          <motion.div {...fadeUp(0.7)} style={{ background: "#f8faff", borderRadius: 16, padding: isMobile ? "16px 20px" : "16px 32px", marginTop: 20, border: "1px solid #e0e7ff", display: "flex", justifyContent: isMobile ? "flex-start" : "space-between", alignItems: isMobile ? "flex-start" : "center", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 16 : 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div style={{ width: 32, height: 32, borderRadius: 16, background: "#4f46e5", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><Award size={18} color="#fff" /></div>
      ...
      {/* ══ SECTION 4: Powerful learning ══ */}
      <section style={{ padding: isMobile ? "40px 0" : "60px 0", background: "#f8f9fc", position: "relative", overflow: "hidden" }}>
        {!isMobile && (
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
              <motion.img loading="lazy" decoding="async" whileHover={{ scale: 1.05 }}
                src="/teacher_4.webp" alt="VR Learning Effortless"
                style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}
              />
            </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px", position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", alignItems: "flex-start", minHeight: isMobile ? "auto" : 450, gap: 40, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: isMobile ? 1 : 1.8, maxWidth: isMobile ? "100%" : 800 }}>
              <motion.div {...fadeLeft(0.1)} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                <Rocket size={18} color="#4f46e5" />
                <span style={{ fontSize: 13, fontWeight: 800, color: "#4f46e5", letterSpacing: "0.1em", textTransform: "uppercase" }}>SIMPLE TO USE</span>
              </motion.div>
              <motion.h2 {...fadeLeft(0.2)} style={{ fontSize: "clamp(32px, 4vw, 44px)", fontWeight: 900, color: "#001a4d", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16, perspective: 1000 }}>
                {[
                  ...
                  <motion.div key={idx} {...fadeLeft(0.4 + idx * 0.1)} whileHover={{ rotateX: 5, rotateY: -5, scale: 1.02, boxShadow: "0 20px 40px rgba(0,0,0,0.08)" }} style={{ display: "flex", alignItems: "center", gap: 20, background: "#ffffff", padding: "20px", borderRadius: 16, boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", transformStyle: "preserve-3d" as const, cursor: "pointer" }}>
                    <div style={{ width: 44, height: 44, borderRadius: 22, background: `${item.color}15`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: item.color }}>
                      <item.icon size={22} strokeWidth={1.5} />
                    </div>
                    <div>
            ...
            {!isMobile && (
              <div style={{ flex: 1.2, position: "relative", minHeight: 450, perspective: 1000 }}>
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} whileHover={{ rotateX: -5, rotateY: 5, scale: 1.05 }} style={{ position: "absolute", bottom: "0%", right: "0%", background: "rgba(255,255,255,0.95)", backdropFilter: "blur(10px)", padding: "12px 20px", borderRadius: 20, boxShadow: "0 15px 35px rgba(0,0,0,0.1)", maxWidth: 260, zIndex: 5, border: "1px solid rgba(79,70,229,0.1)", transformStyle: "preserve-3d" as const }}>
          ...
          <motion.div {...fadeUp(0.6)} style={{ background: "#ffffff", borderRadius: 24, padding: isMobile ? "16px" : "12px 40px", marginTop: 20, border: "1px solid #e2e8f0", boxShadow: "0 10px 30px rgba(0,0,0,0.02)" }}>
      ...
      <section style={{ padding: isMobile ? "40px 0" : "40px 0 60px", background: "#ffffff", position: "relative", overflow: "hidden" }}>
        {!isMobile && (
          <motion.div
            initial={{ opacity: 0, scale: 1.1 }}
            whileInView={{ opacity: 1, scale: 1 }}
          ...
          >
            <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
              <motion.img loading="lazy" decoding="async"
                ...
                src="/teacher_5.webp" alt="VR Curriculum Alignment"
                style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}
              />
            </div>
            <div style={{ position: "absolute", top: 0, left: 0, bottom: 0, width: "40%", background: "linear-gradient(to right, #ffffff 0%, rgba(255,255,255,0.8) 30%, transparent 100%)" }} />
          ...
          <div style={{ display: "flex", alignItems: isMobile ? "flex-start" : "center", minHeight: isMobile ? "auto" : 280, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, maxWidth: isMobile ? "100%" : "45%" }}>
              <motion.div {...fadeLeft(0.1)} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 800, color: "#0052cc", letterSpacing: "0.1em", textTransform: "uppercase" }}>ACADEMIC ALIGNMENT</span>
              </motion.div>
              <motion.h2 {...fadeLeft(0.2)} style={{ fontSize: "clamp(32px, 4vw, 40px)", fontWeight: 900, color: "#001a4d", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12, perspective: 1000 }}>
                {[
                  ...
                  <motion.div key={idx} {...fadeLeft(0.4 + idx * 0.1)} whileHover={{ x: 10, rotateX: 5, rotateY: -5, scale: 1.02, background: "#ffffff", boxShadow: "0 10px 25px rgba(0,0,0,0.05)" }} style={{ display: "flex", alignItems: "center", gap: 16, background: "rgba(255,255,255,0.7)", padding: "12px 20px", borderRadius: 14, border: "1px solid #f1f5f9", transition: "all 0.3s ease", transformStyle: "preserve-3d" as const, cursor: "pointer" }}>
                    <div style={{ width: 44, height: 44, borderRadius: 22, background: `${item.color}15`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: item.color }}>
            ...
            {!isMobile && (
              <div style={{ flex: 1, position: "relative", minHeight: 350, perspective: 1000 }}>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} whileHover={{ rotateX: -5, rotateY: 5, scale: 1.05 }} style={{ position: "absolute", bottom: "-15%", left: "-15%", background: "rgba(255,255,255,0.95)", backdropFilter: "blur(10px)", padding: "12px 20px", borderRadius: 20, boxShadow: "0 15px 35px rgba(0,0,0,0.1)", maxWidth: 260, zIndex: 10, border: "1px solid rgba(79,70,229,0.1)", transformStyle: "preserve-3d" as const }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                    <GraduationCap size={24} color="#4f46e5" strokeWidth={1.5} />
                    <h3 style={{ fontSize: 14, fontWeight: 800, color: "#001a4d", margin: 0, lineHeight: 1.2 }}>Built for classrooms.<br /><span style={{ color: "#4f46e5" }}>Backed by pedagogy.</span></h3>
                  </div>
                  <p style={{ fontSize: 11, color: "#475569", margin: 0, fontWeight: 500, lineHeight: 1.3 }}>SparkVR aligns with educational standards and supports student learning.</p>
                </motion.div>
              </div>
            )}
          </div>
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto 60px", padding: "0 20px", position: "relative", zIndex: 2 }}>
        <motion.div {...fadeUp(0.2)} style={{ background: "#ffffff", borderRadius: 24, padding: isMobile ? "20px" : "20px 40px", border: "1px solid #e2e8f0", boxShadow: "0 20px 50px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : isTablet ? "repeat(3, 1fr)" : "repeat(5, 1fr)", gap: 16, marginBottom: 24 }}>
            {[
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: isMobile ? "flex-start" : "center", padding: isMobile ? "16px" : "16px 32px", background: "linear-gradient(90deg, #f0f5ff 0%, #ffffff 100%)", borderRadius: 20, border: "1px solid #e0e7ff", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 16 : 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div style={{ width: 44, height: 44, borderRadius: 22, background: "#4f46e5", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 5px 15px rgba(79,70,229,0.2)", flexShrink: 0 }}><ShieldCheck size={22} color="#fff" /></div>
              <div>
                <h4 style={{ fontSize: isMobile ? 15 : 17, fontWeight: 800, color: "#001a4d", margin: "0 0 2px 0" }}>Academic alignment you can trust.</h4>
      ...
      <section style={{ padding: isMobile ? "40px 0" : "60px 0", background: "#f8fafc", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px" }}>
          <div style={{ display: "flex", gap: isMobile ? 0 : 60, alignItems: "stretch", marginBottom: 40, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, maxWidth: isMobile ? "100%" : "45%", marginBottom: isMobile ? 32 : 0 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[
                  ...
                  <motion.div key={idx} {...fadeLeft(0.4 + idx * 0.1)} whileHover={{ scale: 1.02, x: 5, boxShadow: "0 10px 25px rgba(0,0,0,0.05)" }} style={{ display: "flex", alignItems: "flex-start", gap: 16, background: "#ffffff", padding: "16px 20px", borderRadius: 16, boxShadow: "0 4px 20px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", cursor: "pointer", transition: "all 0.3s ease" }}>
            ...
            <div style={{ flex: 1, position: "relative", minHeight: isMobile ? 260 : 500 }}>
              <motion.div {...fadeRight(0.4)} style={{ position: "absolute", inset: 0, borderRadius: 24, overflow: "hidden", boxShadow: "0 25px 50px rgba(0,0,0,0.1)" }}>
              ...
              {!isMobile && (
                <>
                  <motion.div initial={{ opacity: 0, x: 30, y: 10 }} whileInView={{ opacity: 1, x: 0, y: 0 }} transition={{ delay: 0.6, duration: 0.6, ease: EASE }} whileHover={{ y: -5, boxShadow: "0 25px 50px rgba(0,0,0,0.12)" }} style={{ position: "absolute", top: 40, right: -30, background: "#ffffff", borderRadius: 16, padding: "20px", boxShadow: "0 20px 40px rgba(0,0,0,0.08)", border: "1px solid #e0e7ff", width: 240, zIndex: 10 }}>
                    <div style={{ background: "linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%)", margin: "-20px -20px 20px -20px", padding: "16px 20px", borderTopLeftRadius: 16, borderTopRightRadius: 16, display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <h4 style={{ color: "#ffffff", fontSize: 15, fontWeight: 800, margin: 0 }}>We're here for you</h4>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                      {[
                  ...
                  <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.8, duration: 0.6, ease: EASE }} whileHover={{ y: -5, scale: 1.02 }} style={{ position: "absolute", bottom: -20, left: -20, maxWidth: 360, background: "rgba(255,255,255,0.95)", backdropFilter: "blur(10px)", padding: "16px 24px", borderRadius: 16, boxShadow: "0 15px 35px rgba(0,0,0,0.08)", border: "1px solid rgba(79,70,229,0.1)", display: "flex", gap: 16, alignItems: "center", zIndex: 10 }}>
          ...
          <motion.div {...fadeUp(0.6)} style={{ background: "#f0f5ff", borderRadius: 24, padding: isMobile ? "20px" : "30px", border: "1px solid #e0e7ff" }}>
            ...
            <div style={{ background: "#ffffff", borderRadius: 16, padding: isMobile ? "16px" : "16px 24px", display: "flex", justifyContent: isMobile ? "flex-start" : "space-between", alignItems: isMobile ? "flex-start" : "center", border: "1px solid #e2e8f0", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 12 : 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <Heart size={20} color="#6366f1" />
                <h4 style={{ fontSize: isMobile ? 14 : 16, fontWeight: 800, color: "#0f172a", margin: 0 }}>We're more than a platform. We're your teaching partner.</h4>
              </div>
              <p style={{ fontSize: isMobile ? 14 : 16, fontWeight: 700, color: "#6366f1", margin: 0 }}>Together, we create better learning experiences.</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section style={{ padding: isMobile ? "40px 0 60px" : "80px 0 60px", background: "#ffffff", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 20px" }}>
          <div style={{ display: "flex", gap: isMobile ? 0 : 60, alignItems: "stretch", marginBottom: 60, flexDirection: isMobile ? "column" : "row" }}>
            <div style={{ flex: 1, maxWidth: isMobile ? "100%" : "45%", marginBottom: isMobile ? 32 : 0 }}>
              ...
              <motion.div {...fadeUp(0.4)} whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.06)" }} style={{ background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", borderRadius: 24, padding: "32px", border: "1px solid #e2e8f0", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", transition: "all 0.3s ease" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 24 }}>
                  <motion.div whileHover={{ rotate: 15, scale: 1.1 }} style={{ width: 80, height: 80, borderRadius: 20, background: "linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 10px 20px rgba(79,70,229,0.3)", flexShrink: 0 }}>
            ...
            <div style={{ flex: 1, position: "relative", minHeight: isMobile ? 260 : 500 }}>
              <motion.div {...fadeLeft(0.4)} style={{ position: "absolute", inset: 0, borderRadius: 24, overflow: "hidden", boxShadow: "0 25px 50px rgba(0,0,0,0.1)" }}>
              ...
              {!isMobile && (
                <motion.div initial="initial" whileInView="whileInView" viewport={{ once: true }} variants={{ initial: {}, whileInView: { transition: { staggerChildren: 0.15, delayChildren: 0.6 } } }} style={{ position: "absolute", top: 40, right: -40, display: "flex", flexDirection: "column", gap: 10, zIndex: 10 }}>
                  {[
                    ...
                    <motion.div key={i} variants={{ initial: { opacity: 0, x: 20 }, whileInView: { opacity: 1, x: 0 } }} transition={{ type: "spring", stiffness: 100, damping: 12 }} whileHover={{ x: -10, scale: 1.05 }} style={{ background: "#ffffff", padding: "12px 24px", borderRadius: 14, display: "flex", alignItems: "center", gap: 16, boxShadow: "0 10px 20px rgba(0,0,0,0.06)", border: "1px solid #e2e8f0", borderLeft: `5px solid ${it.color}`, cursor: "pointer" }}>
          ...
          <motion.div {...fadeUp(0.6)} style={{ background: "#f8fafc", borderRadius: 24, padding: isMobile ? "20px" : "30px", border: "1px solid #e2e8f0" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginBottom: 24 }}>
              <div style={{ height: 2, width: 40, background: "#cbd5e1" }} />
              <h3 style={{ fontSize: 18, fontWeight: 800, color: "#0f172a", textAlign: "center", margin: 0 }}>Why teachers choose SparkVR</h3>
              <div style={{ height: 2, width: 40, background: "#cbd5e1" }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : isTablet ? "repeat(3, 1fr)" : "repeat(5, 1fr)", gap: isMobile ? 12 : 16, marginBottom: 30 }}>
              {[
            ...
            <motion.div whileHover={{ y: -5, borderColor: "#c7d2fe" }} style={{ background: "#ffffff", borderRadius: 20, padding: isMobile ? "20px" : "24px 32px", display: "flex", justifyContent: isMobile ? "flex-start" : "space-between", alignItems: isMobile ? "flex-start" : "center", border: "1px solid #e2e8f0", transition: "all 0.3s ease", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 24 : 0 }}>
              <div style={{ flex: 1, display: "flex", gap: 16, borderRight: isMobile ? "none" : "1px solid #e2e8f0", paddingRight: isMobile ? 0 : 32, borderBottom: isMobile ? "1px solid #e2e8f0" : "none", paddingBottom: isMobile ? 24 : 0 }}>
              ...
              <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 20, paddingLeft: isMobile ? 0 : 32 }}>
                <motion.div whileHover={{ rotate: 10, scale: 1.1 }} style={{ width: 56, height: 56, borderRadius: 16, background: "linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 10px 20px rgba(79,70,229,0.3)", flexShrink: 0 }}><ShieldCheck size={28} color="#fff" /></motion.div>
                <div>
                  <h4 style={{ fontSize: isMobile ? 17 : 20, fontWeight: 900, color: "#0f172a", margin: "0 0 4px 0", letterSpacing: "-0.01em" }}>You teach. We support.</h4>
                  <p style={{ fontSize: isMobile ? 13 : 15, color: "#6366f1", fontWeight: 800, margin: 0 }}>Together, we create better learning.</p>
                </div>
              </div>

              {!isMobile && (
                <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "flex-end", paddingLeft: 32 }}>
